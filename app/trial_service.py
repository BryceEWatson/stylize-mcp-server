...
from app.models import (
    TrialSession, TrialUsageResponse, CreditPackage, UserCredits,
    TrialToAccountRequest, MCPTrialResponse
)
...
class TrialService:
    ...
    def create_session_id(self, ip_address: str, user_agent: Optional[str] = None) -> str:
    ...
    async def _create_new_trial_session(self, ip_address: str, user_agent: Optional[str] = None) -> TrialSession:
