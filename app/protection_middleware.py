...
from app.rate_limiting_service import get_rate_limiting_service, RateLimitType
from app.abuse_monitoring_service import get_abuse_monitoring_service
from app.behavior_analysis_service import get_behavior_analysis_service, RequestEvent
...
def create_protection_middleware(config: Optional[SecurityConfig] = None):
