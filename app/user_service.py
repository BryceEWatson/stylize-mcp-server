...
from app.models import (
    UserProfile, UserRegistrationRequest, UserLoginRequest, SubscriptionTier,
    SubscriptionLimits, UserUsageStats, APIKeyAuth, APIPermission
)
...
class UserService:
    ...
    async def register_user(self, registration: UserRegistrationRequest) -> Tuple[bool, str, Optional[UserProfile]]:
        """Register a new user."""
        try:
    ...
    async def authenticate_user(self, login: UserLoginRequest) -> Tuple[bool, str, Optional[UserProfile]]:
    ...
    async def get_user_usage_stats(self, user_id: str) -> Optional[UserUsageStats]:
    ...
    async def create_user_api_key(self, user_id: str, name: str) -> Tuple[bool, str, Optional[str]]:
