...
class RiskScoringService:
    ...
    async def assess_trial_session_risk(self,
                                      ...
                                      request_history: list | None = None) -> RiskAssessment:
    ...
    async def _collect_risk_factors(self,
                                   ...
                                   request_history: list | None) -> RiskFactors:
...
def get_risk_scoring_service(config: SecurityConfig | None = None) -> RiskScoringService:
